...
describe('Store/weather', () => {
  ...
  describe('reducer', () => {
    ...
    test('It should handle fetchWeather action', () => {
    ...
    test('It should handle fetchWeatherSuccess action', () => {
    ...
    test('It should handle fetchWeatherFailure action', () => {
    ...
    test('It should handle fetchWeatherReset action', () => {
